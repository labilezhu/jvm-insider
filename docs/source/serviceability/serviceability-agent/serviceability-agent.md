...
1. [](project:/appendix-lab-env/build-jdk/inspect-build#inspect-c-preprocessor-gen-code)
2. [](project:appendix-lab-env/build-jdk/inspect-build#inspect-c-preprocessor-gen-code)
3. [](project:/appendix-lab-env/build-jdk/inspect-build#探视-c-preprocessor-生成代码)
4. [](project:appendix-lab-env/build-jdk/inspect-build#c-preprocessor)
